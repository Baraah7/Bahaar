...
/// Refactored integrated map with clean architecture
///
/// Features:
...
class IntegratedMapRefactored extends StatefulWidget {
  const IntegratedMapRefactored({super.key});

  @override
  State<IntegratedMapRefactored> createState() => _IntegratedMapRefactoredState();
}

class _IntegratedMapRefactoredState extends State<IntegratedMapRefactored> {
